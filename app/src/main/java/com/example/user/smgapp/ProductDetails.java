...
/*
        if (!(delivryCity.getText().toString().isEmpty()) && (!tv_pincode.getText().toString().isEmpty())&& (!time_edit_txt.getText().toString().isEmpty()) && (!date_edit_txt.getText().toString().isEmpty())){
       ...
       /* tv_pincode.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (delivryCity.getText().toString().isEmpty() || delivryCity.getText().toString().contains("") || delivryCity.getText().toString().equals("")) {
                    city_alert.setVisibility(View.VISIBLE);
                    city_alert.setText("Please Enter Delivery city First");
                    city_alert.setTextColor(Color.parseColor("#FF0000"));
                ...
                if (tv_pincode.getText().toString().length() >= maxlen) {
                    ...
                    if (autocompletetext.equals(cityfromdb)) {
                        city_alert.setVisibility(View.VISIBLE);
                        city_alert.setText("This city is serviceable");
                        city_alert.setTextColor(Color.parseColor("#008000"));
                    *//*    review_dialog=new Dialog(ProductDetails.this,R.style.AppTheme);
                      ...
                      review_dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                        ...
                        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(ProductDetails.this,
                                android.R.layout.simple_list_item_1, android.R.id.text1, val2);
                        ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(ProductDetails.this,
                                android.R.layout.simple_list_item_1, android.R.id.text1, val3);
...
*//*
                        ...
                        txt_pincode_alert.setText("This pincode is not matching to your city");
                        txt_pincode_alert.setTextColor(Color.parseColor("#FF0000"));
